        ...
        <div className="page" id='Work Experience'>
            ...
            <div className="Jobs">
                <div className="Job">
                    ...
                    <p className="Job-Project-tech"> <b>Technologies: </b>HTML, CSS, JavaScript</p>
                </div>
                ...
                <div className="Job">
                    ...
                    <h3 className='Job-Project-title'>QFin UWA Website (In Progress)</h3>
                    <p className="Job-Project-desc">Creating a Web Application and Email Domain for the QFin UWA club which will display what the club is about our events, executive team and committee, and our sponsors. I am working alongside other developers within QFin to develop the website. The site will be accessible to both desktop and mobile users.</p>
                ...
                <div className="Job">
                    ...
                    <p className="Job-Project-desc">Creating a Web Application for WAIS to help visualise the performance of pole vaulters in training. We will be incorporating computer vision software and user input to allow coaches to best train their athletes. Working in a team of volunteers through Coders For Causes.</p>
