    ...
    return (
        <>
            <div id="project-thumbnail" className="flex justify-center flex-col p-2 text-xl font-semibold">
                ...
                {children.image &&
                    <img id="project-thumbnail-image" className="float-left inline-block w-auto mx-auto h-auto max-h-80 object-cover pr-2 max-w-lg max-md:max-w-full" src={children.image} alt={children.title} />
                }
            </div>
        </>
    );
